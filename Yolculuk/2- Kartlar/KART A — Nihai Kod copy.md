...
## Bu dosyadaki 7 makinenin özeti
...
|`veri_hazirla`|Yukarıdaki 6'sını sırayla çalıştırıp modele hazır veri üretir (USDTRY + ENFLASYON + FAIZ)|hedef gösterge, max lag|temiz, tam dolu, lag'li son tablo|
